...
public class CreditCardNetworkConverter {
    ...
    public static SimpleCreditCardNetworkDTO toSimpleCreditCardNetworkDTO(CreditCardNetworkModel creditCardNetworkModel){
    ...
    //Conversão do dominio para o modelo (jpa)
