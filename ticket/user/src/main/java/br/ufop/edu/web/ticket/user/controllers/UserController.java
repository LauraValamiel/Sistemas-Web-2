...
public class UserController {
    ...
    public ResponseEntity<List<SimpleUserRecordDTO>> getUsersByName(@PathVariable(value = "name") String userName){
        List<SimpleUserRecordDTO> list = userService.getUsersByName(userName);
        return ResponseEntity.ok(list);
    }
